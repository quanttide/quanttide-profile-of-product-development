...
| 角色 | 场景 | 核心诉求 |
|------|------|---------|
| 产品经理 | 梳理产品需求，规划版本路线 | 快速组织用户故事，对齐团队认知 |
| 设计师 | 理解产品全景，确定设计范围 | 直观看到功能边界和优先级 |
| 研发工程师 | 了解迭代计划，明确开发范围 | 清晰知道这次做什么、不做什么 |
| 团队负责人 | 全局把控产品方向 | 可视化产品全景，做出版本决策 |
