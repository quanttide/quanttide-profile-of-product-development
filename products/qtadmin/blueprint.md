...
| 角色 | 场景 | 核心诉求 |
|------|------|---------|
| 创始人 | 查看公司全局状态，获取决策支撑信息 | 快速了解各业务线运行情况 |
| 业务线负责人 | 管理本业务线数据（咨询/课堂/云/数据/招聘） | 高效完成日常 CRUD 和业务追踪 |
| 运营管理员 | 处理人力、资产、通知等职能事务 | 合规检查、批量操作、自动化流程 |
| 知识管理者 | 从文档中提取知识，构建企业知识库 | LLM 辅助的知识采集和本体构建 |
